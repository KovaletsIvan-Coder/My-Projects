...
import "./Basket.css";
import { amountItemInBasketContext } from "../../context";
import { Link } from "react-router-dom";

const Basket = () => {
  const { amountItemInBasket } = useContext(amountItemInBasketContext);
  return (
    <div className="main_basket_container">
      <div className="basket_container">
        <Link className="link_basket" to="/basket">
          <div className="number_in_basket">{amountItemInBasket}</div>
          <svg
